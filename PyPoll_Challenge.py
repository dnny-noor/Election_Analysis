...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        turnout_results = (f"{county_name}: {turnout_percentage:.1f}% ({turnout:,})\n")
        # 6d: Print the county results to the terminal.
        print(turnout_results)
        # 6e: Save the county votes to a text file.
        txt_file.write(turnout_results)
        # 6f: Write an if statement to determine the winning county and get its vote count.
        if (turnout > largest_turnout_county_count) and (turnout_percentage > largest_turnout_county_percentage):
            largest_turnout_county_count = turnout
            largest_turnout_county_percentage = turnout_percentage
